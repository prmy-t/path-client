<template>
  <div>
    <v-row justify="center">
      <v-col align="center">
        <v-card flat color="grey lighten-3" rounded="lg">
          <v-card-title class="justify-center font-weight-bold text-h5">
            Privacy Policy for Path.pk
          </v-card-title>
          <v-card-text>
            <p>
              At Path.pk, accessible from www.path.pk, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by Path.pk and how we use it.
            </p>
            <p>
            ...
            <p>
              ...
              that they shared and/or collect in Path.pk. This policy is not
              applicable to any information collected offline or via channels
              other than this website. Our Privacy Policy was created with the
              help of the
              <a href="https://www.privacypolicygenerator.org/" target="_blank"
                >Free Privacy Policy Generator</a
              >.
            </p>
          </v-card-text>
          <v-card-title class="justify-start font-weight-bold text-h6">
            Consent
          </v-card-title>
          ...
          <v-card-text align="start">
            <p>
              Path.pk follows a standard procedure of using log files. These
          ...
          <v-card-text align="start">
            <P
              ...
              the advertising partners of Path.pk.</P
            >

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Path.pk, which
            ...
            <p>
              Note that Path.pk has no access to or control over these cookies
          ...
          <v-card-text align="start">
            <p>
              Path.pk's Privacy Policy does not apply to other advertisers or
          ...
          <v-card-text align="start">
            ...
            <p>
              Path.pk does not knowingly collect any Personal Identifiable
